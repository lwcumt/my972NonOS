...
#if (LCD_SIZE==LCDTYPE_15)
// static VPOST_T DEF_E50A2V1 = { 1024, 768, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, (844<<16)|1664, (768<<16)|1024,((1664-16)<<16)|(1664-20), ((1664-320)<<16)|(1664-320)  ,((844-38)<<16)|(844-38)};//(28<<16)+28, (10<<16)+10, (29<<16)+13};//
static VPOST_T DEF_E50A2V1 = { 1024, 768, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, ((768+38)<<16)|(1024+88), (768<<16)|1024,((1024+10)<<16)|(1024+3), ((0)<<16)|(0)  ,((768+10)<<16)|(768+3)};//(28<<16)+28, (10<<16)+10, (29<<16)+13};//
	
////	// static VPOST_T DEF_E50A2V1 = { 1024, 768, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, (844<<16)|1664, (768<<16)|1024,((1664-16)<<16)|(1664-20), ((1664-320)<<16)|(1664-320)  ,((844-38)<<16)|(844-38)};//(28<<16)+28, (10<<16)+10, (29<<16)+13};//
////static VPOST_T DEF_E50A2V1 = { 1024, 768, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, ((768+30)<<16)|(1024+40), (768<<16)|1024,((1024+10)<<16)|(1024+3), ((0)<<16)|(0)  ,((768+5)<<16)|(768+1)};//(28<<16)+28, (10<<16)+10, (29<<16)+13};//
////	
#elif (LCD_SIZE==LCDTYPE_7)
static VPOST_T DEF_E50A2V1 = { 800, 480, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, (525<<16)|1056, (480<<16)|800,((1056-46)<<16)|(1056-210), ((1056-8)<<16)|(1056-40)  ,((525-22)<<16)|(525-23)};//(28<<16)+28, (10<<16)+10, (29<<16)+13};//
#else
//	8----------------10------------
// #elif LCD_SIZE==LCDTYPE_8//群创
static VPOST_T DEF_E50A2V1 = { 800, 600, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, (635<<16)|1056, (600<<16)|800,((1056-46)<<16)|(1056-210), ((1056-8)<<16)|(1056-40)  ,((635-12)<<16)|(635-23)};//(28<<16)+28, (10<<16)+10, (29<<16)+13};//

#endif

// #else //LCD_SIZE==LCDTYPE_10//天马
static VPOST_T DEF_E50A2V2 = { 800, 600, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, 
								(645<<16)|1000,					/*!< CRTCSIZE register value */  			//only one 645
								(600<<16)|800,					/*!< CRTCDEND register value */
								((800+8)<<16)|(800+5),			/*!< CRTCHR register value */    			//no care
								((1000-100)<<16)|(1000-82)  ,	/*!< CRTCHSYNC register value */  			//only one 82
								((600+10)<<16)|(600+6)};		/*!< CRTCVR register value */				//no care 

	

//  7" 800*480 配置
//static VPOST_T DEF_E50A2V1 = { 800, 600, 0, 0, 0, VPOSTB_DATA16or18, 0, VPOSTB_COLORTYPE_64K, VPOSTB_DEVICE_SYNC_HIGHCOLOR, 0x02040368, 0x01e00320,0x03250321, 0x3600340  ,0x01f001ed};//(28<<16)+28, (10<<16)+10, (29<<16)+13};//
...
static VPOST_T* DisplayDevList[3] = {&DEF_E50A2V1, &DEF_E50A2V2, &DEF_LSA40AT9001};
