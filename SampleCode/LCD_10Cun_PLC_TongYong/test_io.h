...
#define IO_STUS_X1 80//80
#define IO_STUS_Y1 170//200
#define IO_STUS_X2 (IO_STUS_X1+IO_STUS_W-20)
...
#define T_DISKEY_W   54//60
#define T_DISKEY_H   30
#define TSTMOD_COL_0  IO_STUS_X1//110  //列
