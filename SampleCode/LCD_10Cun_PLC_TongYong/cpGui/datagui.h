...
unsigned short Drawx;
unsigned short Drway;
}CHART;
...
LOCATION Location;	//定位
SIZE Size; //总大小
unsigned char Align;//对齐  0,左对齐  1:右对齐
...
#define DisArea_RAM_ADD 0x83100000
...
extern unsigned char Old_FormActive[128];
extern unsigned short ChartDrawData[512];
extern unsigned short ChartDataScanIndex;
