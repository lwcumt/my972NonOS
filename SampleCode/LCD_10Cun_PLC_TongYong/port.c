...
void AllSensor_IN_Get(void)
{
	...
	#ifdef PLC_3U
	if(Knife_Sensor_Status==0) //  刀 下---0
	{
	OIN2_PIN_up_flag=0;
		
		if(OIN2_PIN_down_flag1==0)
		{
		//OIN2_PIN_time=0;
		OIN2_PIN_down_flag1=1;
