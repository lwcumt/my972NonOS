...
uint16_t Setting_User_Count[2];//设置的使用次数
...
FileFolderRead("主电源关up.bmp",(unsigned char*)POWER_OFF_UP_sdram);
FileFolderRead("主电源关down.bmp",(unsigned char*)POWER_OFF_DOWN_sdram);
////////FileFolderRead("主机关.bmp",(unsigned char*)POWER_ON_UP_sdram);
////////FileFolderRead("主机开.bmp",(unsigned char*)POWER_ON_DOWN_sdram);
//////FileFolderRead("主电源关up.bmp",(unsigned char*)POWER_OFF_UP_sdram);
//////FileFolderRead("主电源关down.bmp",(unsigned char*)POWER_OFF_DOWN_sdram);
//////FileFolderRead("电源黑.bmp",(unsigned char*)POWER_CTRL_sdram);
FileFolderRead("正常换刀.bmp",(unsigned char*)LIGHT_KNIFE_DOWN_sdram);
FileFolderRead("对刀灯off.bmp",(unsigned char*)LIGHT_KNIFE_UP_sdram);
FileFolderRead("灯控.bmp",(unsigned char*)LIGHT_CTRL_sdram);
FileFolderRead("灯光开.bmp",(unsigned char*)LIGHT_LED_DOWN_sdram);
FileFolderRead("灯光关.bmp",(unsigned char*)LIGHT_LED_UP_sdram);
...
FileFolderRead("fast_knife.bmp",(unsigned char*)NORMAL_KNIFE_DOWN_sdram);
FileFolderRead("fast_knife_dis.bmp",(unsigned char*)NORMAL_KNIFE_UP_sdram);


FileFolderRead("manual_knife.bmp",(unsigned char*)MANUAL_KNIFE_DOWN_sdram);
FileFolderRead("manual_knife_dis.bmp",(unsigned char*)MANUAL_KNIFE_UP_sdram);

FileFolderRead("motor_knife.bmp",(unsigned char*)ELECTRIC_KNIFE_DOWN_sdram);
FileFolderRead("motor_knife_dis.bmp",(unsigned char*)ELECTRIC_KNIFE_UP_sdram);
...
FileFolderRead("F5密码保护.bmp",(unsigned char*)F5_PASSWORD_SET_sdram);
...
Printf16("Copyright(c)lwcumt-v202003 Limited,All Rights Reserved.",10,10,RED_COLOR,0,0xffff);
...
switch(mode)
	...
	case READ_PRO_MODE://查找模式
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_10[];   ////10：查找模式 ?????????
				Thai_Draw(Thai_Font17_Pic_10,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*4;
				vietnam_print((unsigned char *)Viet_Font24_Pic_10,x,y,line_color,0,back_color);
					break;
			}
			break;
	case AUTO_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_6[];   ////6：自动模式    ?????????
				Thai_Draw(Thai_Font17_Pic_6,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*4;
				vietnam_print((unsigned char *)Viet_Font24_Pic_6,x,y,line_color,0,back_color);
					break;
			}
			break;	
	case MANUAL_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_5[];   ////5：手动模式      ?????????
				Thai_Draw(Thai_Font17_Pic_5,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;
				vietnam_print((unsigned char *)Viet_Font24_Pic_5,x,y,line_color,0,back_color);
					break;
			}	
			break;	
	case TEACH_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_8[];   ////8：示教模式   ?????????????
				Thai_Draw(Thai_Font17_Pic_8,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*3;
				vietnam_print((unsigned char *)Viet_Font24_Pic_8,x,y,line_color,0,back_color);
					break;
			}
			break;
	case SELF_CUT_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_7[];   ////7：自刀模式    ????????????
				Thai_Draw(Thai_Font17_Pic_7,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;
				vietnam_print((unsigned char *)Viet_Font24_Pic_7,x,y,line_color,0,back_color);
					break;
			}	
			break;
	case HELP_MODE:
	...
	case TEACH_LABEL_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_22[];   ////22：标签模式  ????????
				Thai_Draw(Thai_Font17_Pic_22,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;	
				vietnam_print(Viet_Font24_Pic_22,x,y,line_color,0,back_color);
					break;
			}	
			break;
	...
	case TEACH_DIVIDE_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_23[];   ////23：等分模式 ???????????????
				Thai_Draw(Thai_Font17_Pic_23,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;	
				vietnam_print(Viet_Font24_Pic_23,x,y,line_color,0,back_color);
					break;
			}	
			break;
	// // case TEACH_PRO_MODE:
	...
	// // case SELF_RULER_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_52[];   ////52：基准模式 ???????????
				Thai_Draw(Thai_Font17_Pic_52,x+40,y-5,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语	
				x+=12*2;	
				vietnam_print(Viet_Font24_Pic_52,x,y,line_color,0,back_color);
					break;
			}
			break;
	...
	// // case SELF_TOOLS_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_51[];   ////51：参数模式 ???????????
				Thai_Draw(Thai_Font17_Pic_51,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;	
				vietnam_print(Viet_Font24_Pic_51,x,y,line_color,0,back_color);
					break;
			}	
			break;
	case AUTO_PLUS_MODE:
	case TEACH_PLUS_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_31[];   ////31：自加模式 ??????????????
				Thai_Draw(Thai_Font17_Pic_31,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;	
				vietnam_print(Viet_Font24_Pic_31,x,y,line_color,0,back_color);
					break;
			}	
			break;
	...
	case TEACH_MINUS_MODE:
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_32[];   ////32：自减模式 ???????????
				Thai_Draw(Thai_Font17_Pic_32,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;	
				vietnam_print(Viet_Font24_Pic_32,x,y,line_color,0,back_color);
					break;
			}	
			break;
	case MANUAL_CLOCK_MODE:
		switch(Language)
			...
			case THAILAND:
								x+=12*2;
			//unsigned short const Thai_Font17_Pic_60[];   ////60：时间模式 ????????
				Thai_Draw(Thai_Font17_Pic_60,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;	
				vietnam_print((unsigned char *)Viet_Font24_Pic_60,x,y,line_color,0,back_color);
					break;
			}	
			break;
	case MANUAL_PULSE_MODE:  //设定脉冲当量
		switch(Language)
			...
			case THAILAND:
				x+=12*2;	
			//unsigned short const Thai_Font17_Pic_61[];   ////61：脉冲当量模式 ?????????
				Thai_Draw(Thai_Font17_Pic_61,x+50,y,line_color,0,back_color);
					break;
			case VIETNAMESE:	//越南语
				x+=12*2;	
				vietnam_print((unsigned char *)Viet_Font24_Pic_61,x,y,line_color,0,back_color);
					break;
			}		
			break;
...
void F5PasswordSetUp_dis(Int16U x,Int16U y)//F5密码保护
{
Bmp_Decode((Int32U)F5_PASSWORD_SET_sdram, x, y, (pInt16U)SDRAM0_BASE_ADDR);
}
...
switch(Language)
	{
	case CHN_HAN:
		Printf24("下刀次数 ",x,y,BLACK_COLOR,1,b_color);
	...
	case SPANISH: //西班牙
	case VIETNAMESE:	//越南语
			Printf24("K DOWN CNT ",x,y,BLACK_COLOR,1,b_color);
			break;
	case THAILAND:
			Printf24("K DOWN CNT ",x,y,BLACK_COLOR,1,b_color);
	 break;
...
num[0]=size/100000;	
num[1]=size%100000/10000;
num[2]=size%100000%10000/1000;
num[3]=size%100000%10000%1000/100;	
num[4]=size%100000%10000%1000%100/10;	
num[5]=size%100000%10000%1000%100%10;		
...
GLCD_SetWindow_Fill(x,y,x+16*6,y+32,back_color,back_color);	

ASCII_Printf(strtemp,64+1,16,32,ASCII_bold16x32, x+k*16,y,WHITE_COLOR,back_color);
////////	
////////Int8U num[8],k;
////////Int16U x,y,back_color=WIN_DOWN_BACK_COLOR;
////////x=MARK_LABEL_DATA_X;
...
x2=S6_AMEND_BUTT_X+DELETE_ALL_BUT_WIDE,y2=DELETE_ALL_Y+DELETE_ALL_BUT_HIGH+8;
...
switch(mode)
	...
	case MANUAL_MODE:	//手动模式..............
			...
			F5PasswordSetUp_dis(F5_BUTTON_X , F5_BUTTON_Y);//F5密码保护
...
x2=DATA_TABLE_END_X,y2=RIGHT_ARROW_Y+Kf_Line_HIGH*PageKf_Size-txtbank_y;
...
//**************************************编程 下
void ProgSet_dis_new(Int32U size, Int16U x, Int16U y, Int8U set_flag,Int8U dis_cnt)// 参数设定页内 选项数据显示
{
Int8U num[10],k,int_flag=0;//0xef9f;
Int16U back_color=TEXT_TAB_BACK_COLOR; //文本页  背景色
switch(WorkMode)
	{
	case AUTO_LABEL_MODE://已在 标签画面		
...
////////////			}
		...
		if(dis_cnt==0)	// 带小数
			...
			num[0]=size/10000000;
			num[1]=(size/1000000)%10;
			num[2]=(size/100000)%10;
			num[3]=(size/10000)%10;
			num[4]=(size/1000)%10;
			num[5]=(size/100)%10;
			num[6]=(size/10)%10;
			num[7]=size%10;//10000000;
			num[8]=0;
...
x=F3_PRO_CAPTION_X+35,y=F3_PRO_CAPTION_Y;
// CurrentArea_save2(MIDDLE_PAGE_X , MIDDLE_PAGE_Y,  M_PAGE_WIDE, M_PAGE_HIGH);
MiddlePage_dis();//中间活页
//主模式......
...
switch(Language)
	{
	case CHN_HAN:
		Printf16("序号     名称",x,y,line_color,0,back_color);	x+=290;
		Printf16("步骤     修改日期",x,y,line_color,0,back_color);
			break;
	case ENGLISH:	
	case VIETNAMESE:	//越南语
		Printf16("Order    Name",x,y,line_color,0,back_color);	x+=290;
		Printf16("Step     Modified",x,y,line_color,0,back_color);
			break;
	case INDONSIA:	//印尼	
		Printf16("Tidak.   Nama",x,y,line_color,0,back_color);	x+=290;
		...
		switch(Language)
			...
			case SPANISH: //西班牙
				...
				ASCII_Printf("n",ASCII24_MODE,12,24,PUTAO_ZK24,x+12*4,y,front_color, back_color);
					break;
			case THAILAND:
				Printf24("Thai",x,y,front_color,1,back_color); //语言
					 break;
			case VIETNAMESE:	//越南语
				vietnam_print(Viet_Font24_Pic_TiengViet,x,y,front_color,1,back_color);
									 break;
			}
		if(flag==1)
			{
...
//			temp=Aheader*100/254;
		...
		//			Printf24("0        0.038",REMIND_WINDOW_X+200,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
			...
			{
				//显示总下刀数
					ProgSet_dis_new(temp,  x,  y,  flag,0);//	ProgSetNull_dis( x,  y,  flag);//参数不显示----------20190114
			}
		break;
		/*
	case 6://标准距离
	...
	//	else
		...
		ProgSet_dis_new(temp,  x,  y,  flag,5);
		if(flag==1)
			{
			switch(Language)
				{
		...
		//	if(Unit==UNIT_MM)
				Printf24("200      10000",REMIND_WINDOW_X+200,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
		//	else
		//		Printf24("0           7.8",REMIND_WINDOW_X+200,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);					
////////			if(Unit==UNIT_MM)
////////				Printf24("2           200",REMIND_WINDOW_X+200,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
////////			else
////////				Printf24("0           7.8",REMIND_WINDOW_X+200,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);	
			}
		break;	
					...
					switch(Language)
						...
						case SPANISH: //西班牙
							Printf24("alto",x,y,front_color,1,back_color); //
								break;
						case THAILAND:
							// unsigned short const Thai_Font17_Pic_50[];   ////50：高有效 ?????????
							Thai_Draw(Thai_Font17_Pic_50,x,y,front_color,1,back_color); //
								break;
						case VIETNAMESE://越南语
							vietnam_print((unsigned char *)Viet_Font24_Pic_50,x,y,front_color,1,back_color); //
								break;
						}		
					}
				else
					...
					switch(Language)
						...
						case SPANISH: //西班牙
							Printf24("bajo",x,y,front_color,1,back_color); //
								break;
						case THAILAND:
							//unsigned short const Thai_Font17_Pic_49[];   ////49：低有效 ?????????
							Thai_Draw(Thai_Font17_Pic_49,x,y,front_color,1,back_color); //
								break;
						case VIETNAMESE:	//越南语
							vietnam_print((unsigned char *)Viet_Font24_Pic_49,x,y,front_color,1,back_color); //
								break;
						}		
					}
				if(flag==1)	
		...
		switch(MotorType)
			...
			// // case MOTOR_DC670_SERVO:
				...
				// // if(flag==1)
					...
					// // break;
			case MOTOR_AC_SERVO:
			case MOTOR_AC_SERVO_REV://光电选择改成下刀时间  2025 03
			//		if(Unit==UNIT_MM)//mm  单位
			//		temp=AC_MotorSPD*100;
			//	else
			//		temp=AC_MotorSPD*1000;
				...
				ProgSet_dis_new(temp,  x,  y,flag,  2);
			...
			//	ProgSet_dis(temp,  x,  y,  flag);			
				if(flag==1)
					...
					Printf24("1        30",REMIND_WINDOW_X+200,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);	
					}			
//////////			
//////////				GLCD_SetWindow_Fill( x, y, x+tx_wide, y+24, TEXT_TAB_BACK_COLOR, TEXT_TAB_BACK_COLOR);//clear text win
//////////				if(IR_SensorStus==1)		//红外  有效电平
...
void ParamTable_dis(void) //table
{
volatile Int16U x,y,n;
Int16U line_color=0,Line_X=PARA_TAB_WIDE;
x=MIDDLE_PAGE_X,y=MIDDLE_PAGE_Y;
for(n=0;n<=7;n++)
	{
	DrawLine(x,y, x+Line_X,y,line_color);y+=PARA_ROW_GAP;
	}
// x=MIDDLE_PAGE_X
y=MIDDLE_PAGE_Y;
DrawLine(x,y, x,y+PARA_ROW_GAP*7,line_color);x+=PARA_TAB_WIDE/2;	
DrawLine(x,y, x,y+PARA_ROW_GAP*7,line_color);x+=PARA_TAB_WIDE/2;	
DrawLine(x,y, x,y+PARA_ROW_GAP*7,line_color);	
}
...
switch(Language)
	...
	case CHN_HAN:
		...
		Printf24("单位:",x,y,BLACK_COLOR,1,back_color);  y+=gap;
			Printf24("裁切总数:  ",x,y,BLACK_COLOR,1,back_color);y+=gap;//	Printf24("提前量:  ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		...
		Printf24("保养次数:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;//Printf24("关气距离:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		switch(MotorType)
			{
			case MOTOR_FREQ_5_SPD_RST:
			case MOTOR_FREQ_3_SPD:
			...
			case MOTOR_AC_SERVO_REV:
				...
				Printf24("下刀时间:   ",x,y,BLACK_COLOR,1,back_color);//光电选择改成下刀时间 设置 2025 03
				//Printf24("光电选择:   ",x,y,BLACK_COLOR,1,back_color);
					break;
			}
			break;
	case ENGLISH:	
		...
		Printf24("CUT Count:",x,y,BLACK_COLOR,1,back_color);y+=gap;
		...
		switch(MotorType)
			...
			case MOTOR_AC_SERVO_REV:
				...
				Printf24("K-DownTime:   ",x,y,BLACK_COLOR,1,back_color);//光电选择改成下刀时间
			//Printf24("IR-Set:   ",x,y,BLACK_COLOR,1,back_color);
					break;
			}
			break;
	...
	case PORTUGAL:	//葡萄牙
		...
		switch(MotorType)
			...
			case MOTOR_AC_SERVO:
			case MOTOR_AC_SERVO_REV:
				Printf24("Veloci-corrida:",x,y,BLACK_COLOR,1,back_color);y+=gap;
				Printf24("K-DownTime:   ",x,y,BLACK_COLOR,1,back_color);//光电选择改成下刀时间		
			//	Printf24("estado IR:",x,y,BLACK_COLOR,1,back_color);
					break;
			}
	...
	case THAILAND:
		...
		Thai_Draw(Thai_Font17_Pic_36,x,y,BLACK_COLOR,1,back_color);y+=gap;
			
		//Printf24("中极限:    ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		//unsigned short const Thai_Font17_Pic_37[];   ////37：中极限 ?????????	
		Thai_Draw(Thai_Font17_Pic_37,x,y,BLACK_COLOR,1,back_color);y+=gap;
			
		//Printf24("后极限:    ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		//unsigned short const Thai_Font17_Pic_38[];   ////38：后极限 ?????????	
		Thai_Draw(Thai_Font17_Pic_38,x,y,BLACK_COLOR,1,back_color);y+=gap;
			
		//Printf24("语言:    ",x,y,BLACK_COLOR,1,back_color);  y+=gap;
		//unsigned short const Thai_Font17_Pic_39[];   ////39：语言 ????
		Thai_Draw(Thai_Font17_Pic_39,x,y,BLACK_COLOR,1,back_color);  y+=gap;

		//Printf24("单位:",x,y,BLACK_COLOR,1,back_color);  y+=gap;
			//unsigned short const Thai_Font17_Pic_40[];   ////40：单位 ?????
		Thai_Draw(Thai_Font17_Pic_40,x,y,BLACK_COLOR,1,back_color);  y+=gap;
		...
		Thai_Draw(Thai_Font17_Pic_43,x,y,BLACK_COLOR,1,back_color);
			
		x+=PARA_COL_WIDE;y=PARA_START_Y;
		GLCD_SetWindow_Fill( x, y, x+tx_wide, y+(gap*4-10), TEXT_TAB_BACK_COLOR, TEXT_TAB_BACK_COLOR);//clear text win
		//Printf24("压纸停机:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		//unsigned short const Thai_Font17_Pic_44[];   ////44：压纸停机 ????????????????
		Thai_Draw(Thai_Font17_Pic_44,x,y,BLACK_COLOR,1,back_color);y+=gap;
				
		//Printf24("关气距离:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		//unsigned short const Thai_Font17_Pic_46[];   ////46：关气距离  ?????????
		Thai_Draw(Thai_Font17_Pic_46,x,y,BLACK_COLOR,1,back_color);y+=gap;
		...
		switch(MotorType)
			...
			case MOTOR_FREQ_3_SPD_RST:
				...
				Thai_Draw(Thai_Font17_Pic_48,x,y,BLACK_COLOR,1,back_color);
					break;
			// // case MOTOR_DC_SERVO:
			// // case MOTOR_DC670_SERVO:
				// // Printf16("最大速度:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
			...
			case MOTOR_AC_SERVO_REV:
				...
				Thai_Draw(Thai_Font17_Pic_47,x,y,BLACK_COLOR,1,back_color);y+=gap;
	...
	case VIETNAMESE:	//越南语
		...
		Printf24("Advanced:",x,y,BLACK_COLOR,1,back_color);y+=gap;
		vietnam_print((unsigned char *)Viet_Font24_Pic_43,x,y,BLACK_COLOR,1,back_color);
		x+=PARA_COL_WIDE;y=PARA_START_Y;
		GLCD_SetWindow_Fill( x, y, x+tx_wide, y+(gap*4-10), TEXT_TAB_BACK_COLOR, TEXT_TAB_BACK_COLOR);//clear text win
		...
		switch(MotorType)
			...
			case MOTOR_AC_SERVO_REV:
				...
				Printf24("K-DownTime:   ",x,y,BLACK_COLOR,1,back_color);
					break;
			}
	 		break;
	}
...
switch(Language)
	{
	case CHN_HAN:
		Printf24("步进距离:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		Printf24("误差范围:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		Printf24("IR模式:    ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		Printf24("自压时间:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
			break;
	case ENGLISH:
	case INDONSIA:	//印尼	
	case PORTUGAL:	//葡萄牙
	case SPANISH: //西班牙
	case VIETNAMESE:	//越南语
		Printf24("step-dist:   ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		Printf24("Vir_Gap:    ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		Printf24("IR change:    ",x,y,BLACK_COLOR,1,back_color);y+=gap;
		Printf24("Press—Time:  ",x,y,BLACK_COLOR,1,back_color);y+=gap;
			break;
...
switch(Language)
	...
	case CHN_HAN:
		Printf24("请输入密码!",REMIND_WINDOW_X,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
			break;
	case ENGLISH:	
		Printf24("Enter password!",REMIND_WINDOW_X,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
			break;
	case INDONSIA:	//印尼
		Printf24("Masukkan sandi Anda",REMIND_WINDOW_X,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
			break;
	...
	case THAILAND:
		...
		Thai_Draw(Thai_Font17_Pic_54,REMIND_WINDOW_X,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
		break;
	case VIETNAMESE:	//越南语
		vietnam_print((unsigned char *)Viet_Font24_Pic_54,REMIND_WINDOW_X,REMIND_WINDOW_Y+5,RED_COLOR,0,0xffff);
		break;
	}
switch(Language)
	{
	case CHN_HAN:
		Printf32("请输入6位密码!",150,250,RED_COLOR,0,0xffff);
			break;
	case THAILAND:
		//unsigned short const Thai_Font25_Pic_53[];   ////53：请输入6位密码 687610  ?????????????6????
		Thai_Draw(Thai_Font25_Pic_53,150,250,RED_COLOR,0,0xffff);		
		break;
	default:
		Printf32("input password!",150,250,RED_COLOR,0,0xffff);
			break;
	}
}
...
switch(Language)
	...
	case SPANISH: //西班牙
		...
		Printf24("minuto:",x,y,BLACK_COLOR,0,0xffff);
			break;
	case THAILAND:
		//unsigned short const Thai_Font17_Pic_55[];   ////55：年 ??
		Thai_Draw(Thai_Font17_Pic_55,x,y,BLACK_COLOR,0,0xffff);;
		Printf24("      20",x,y,BLACK_COLOR,0,0xffff);y+=gap;
	  //unsigned short const Thai_Font17_Pic_56[];   ////56：月 ?????
		Thai_Draw(Thai_Font17_Pic_56,x,y,BLACK_COLOR,0,0xffff);y+=gap;
	//unsigned short const Thai_Font17_Pic_57[];   ////57：日 ???
		Thai_Draw(Thai_Font17_Pic_57,x,y,BLACK_COLOR,0,0xffff);y+=gap;
	//unsigned short const Thai_Font17_Pic_58[];   ////58：小时 ???????
		Thai_Draw(Thai_Font17_Pic_58,x,y,BLACK_COLOR,0,0xffff);y+=gap;
	//unsigned short const Thai_Font17_Pic_59[];   ////59：分钟 ????
		Thai_Draw(Thai_Font17_Pic_59,x,y,BLACK_COLOR,0,0xffff);
	 break;
	case VIETNAMESE://越南语
		vietnam_print((unsigned char *)Viet_Font24_Pic_55,x,y,BLACK_COLOR,0,0xffff);;
		Printf24("      20",x,y,BLACK_COLOR,0,0xffff);y+=gap;
		vietnam_print((unsigned char *)Viet_Font24_Pic_56,x,y,BLACK_COLOR,0,0xffff);y+=gap;
		vietnam_print((unsigned char *)Viet_Font24_Pic_57,x,y,BLACK_COLOR,0,0xffff);y+=gap;
		vietnam_print((unsigned char *)Viet_Font24_Pic_58,x,y,BLACK_COLOR,0,0xffff);y+=gap;
		vietnam_print((unsigned char *)Viet_Font24_Pic_59,x,y,BLACK_COLOR,0,0xffff);
	 break;
	}
for(n=1;n<5;n++)
	{
...
switch(Language)
	...
	case SPANISH: //西班牙
		Printf24("Entrada de pulsos equivalente!",REMIND_WINDOW_X+10,REMIND_WINDOW_Y+5,BLACK_COLOR,0,0xffff);
			break;
	case THAILAND:
		//unsigned short const Thai_Font17_Pic_62[];   ////62：请输入脉冲当量 ?????????????????
		Thai_Draw(Thai_Font17_Pic_62,REMIND_WINDOW_X,REMIND_WINDOW_Y,BLACK_COLOR,0,0xffff);	
	 break;
	case VIETNAMESE:	//越南语
		vietnam_print((unsigned char *)Viet_Font24_Pic_62,REMIND_WINDOW_X+10,REMIND_WINDOW_Y+5,BLACK_COLOR,0,0xffff);
		break;
	}
...
switch(Language)
	...
	case THAILAND:
		...
		//unsigned short const Thai_Font17_Pic_ZiDao1[];
		Thai_Draw(Thai_Font17_Pic_ZiDao1,x,y,front_color,1,back_color);y+=30;
	  //unsigned short const Thai_Font17_Pic_ZiDao2[];
		Thai_Draw(Thai_Font17_Pic_ZiDao2,x,y,front_color,1,back_color);x+=40,y+=50;
		
		//Printf24("确认",x,y,front_color,1,back_color);x+=120;
		//Printf24("取消",x,y,front_color,1,back_color);
		//unsigned short const Thai_Font17_Pic_14[];   ////14：确认 ????
		Thai_Draw(Thai_Font17_Pic_14,x+6,y-8,front_color,1,back_color);x+=120;
	
		//unsigned short const Thai_Font17_Pic_15[];   ////15：取消 ??????
		Thai_Draw(Thai_Font17_Pic_15,x+30,y-8,front_color,1,back_color);
	 break;
	case VIETNAMESE://越南语

		vietnam_print((unsigned char *)Viet_Font24_Pic_16_1,x,y,front_color,1,back_color);y+=30;
		vietnam_print((unsigned char *)Viet_Font24_Pic_16_2,x,y,front_color,1,back_color);x+=40,y+=50;
		
		vietnam_print((unsigned char *)Viet_Font24_Pic_14,x,y,front_color,1,back_color);x+=120;
	
		vietnam_print((unsigned char *)Viet_Font24_Pic_15,x,y,front_color,1,back_color);
	 break;
	}
...
switch(Language)
	...
	case SPANISH: //西班牙
		...
		Printf24("Cancelar",x,y,front_color,1,back_color);
			break;
	case THAILAND:
		Thai_Draw(Thai_Font17_Pic_ShiFouJiXuZiDao1,x,y,front_color,1,back_color);y+=30;
		Thai_Draw(Thai_Font17_Pic_ShiFouJiXuZiDao2,x,y,front_color,1,back_color);x+=40,y+=50;
//unsigned short const Thai_Font17_Pic_ZiDao1[];
		Thai_Draw(Thai_Font17_Pic_ZiDao1,x,y,front_color,1,back_color);y+=30;
	  //unsigned short const Thai_Font17_Pic_ZiDao2[];
		Thai_Draw(Thai_Font17_Pic_ZiDao2,x,y,front_color,1,back_color);x+=40,y+=50;
	...
	case VIETNAMESE://越南语
		...
		// vietnam_print((unsigned char *)Viet_Font24_Pic_16_1,x,y,front_color,1,back_color);
		y+=30;
		// vietnam_print((unsigned char *)Viet_Font24_Pic_16_2,x,y,front_color,1,back_color);
		x+=40,y+=50;
...
switch(Language)
	{
	case CHN_HAN:
		Printf24("设定次数:",x,y,BLACK_COLOR,0,0xffff);y+=gap;
			break;
	case ENGLISH:	
...
switch(sel)
	{
	case 0://第一次 天数		
		if(Setting_User_Count[0]==0xA55A)
				ProgSet_dis(0,  x,  y,  flag); //
		else		
				ProgSet_dis(Setting_User_Count[0],  x,  y,  flag); //		
...
FirstBack_dis();//底层背景
Plc_Ext_Form_Init();//替换原来的主机开关 、灯、风泵开关 图标	
...
switch(Language)
	...
	case SPANISH: //西班牙
		Printf24("Programa",xp,yp,BLACK_COLOR,1,back_color);
			break;	
	case THAILAND:
	//unsigned short const Thai_Font17_Pic_2[];   ////2：程序     ???????
		Thai_Draw(Thai_Font17_Pic_2,xp,yp,BLACK_COLOR,1,back_color);
	 break;	
	case VIETNAMESE://越南语
		vietnam_print((unsigned char *)Viet_Font24_Pic_2,xp,yp,BLACK_COLOR,1,back_color);
	 break;	
	}
xp=STEP_X;//
switch(Language)
	...
	case SPANISH: //西班牙
		Printf24("Paso",xp,yp,BLACK_COLOR,1,back_color);
			break;	
	case THAILAND:
	//unsigned short const Thai_Font17_Pic_3[];   ////3：步骤   ???????
		Thai_Draw(Thai_Font17_Pic_3,xp,yp,BLACK_COLOR,1,back_color);
	 break;
	case VIETNAMESE://越南语
		vietnam_print((unsigned char *)Viet_Font24_Pic_3,xp,yp,BLACK_COLOR,1,back_color);
	 break;
	}
...
void CurrentArea_save5(Int16U x,Int16U y, Int16U Wide,Int16U High)//暂存  当前区域 画面5
{
pInt16U pDis,pBuf;
volatile Int16U h,w;
pDis=(pInt16U)(SDRAM0_BASE_ADDR+(y*C_GLCD_H_SIZE+x)*2);
pBuf=(pInt16U)PIC_DIS_SAVE5;
for(h=0;h<High;h++)
  {
  for(w=0;w<Wide;w++)
    {
...
void CurrentArea_recover5(Int16U x, Int16U y, Int16U Wide,Int16U High)//恢复  当前区域 画面5
{
pInt16U pDis,pBuf;
volatile Int16U h,w;
pDis=(pInt16U)(SDRAM0_BASE_ADDR+(y*C_GLCD_H_SIZE+x)*2);
...
Int8U num[4],k;
back_color=STEP_BACK_COLOR;//----------
x=STEP_NUM_X+4*12,y=STEP_NUM_Y;
...
switch(Language)
	...
	case THAILAND:
			...
			Thai_Draw(Thai_Font17_Pic_TZQ,PUSH_RESET_PROMPT_X1+80,PUSH_RESET_PROMPT_Y1+5,BLACK_COLOR,1,0xffff);
	//	Printf24("确定",PUSH_RESET_OK_X,PUSH_RESET_OK_Y,BLACK_COLOR,1,0xffff);
	//	Printf24("取消",PUSH_RESET_CANCEL_X,PUSH_RESET_CANCEL_Y,BLACK_COLOR,1,0xffff);
			Thai_Draw(Thai_Font17_Pic_14,PUSH_RESET_OK_X,PUSH_RESET_OK_Y,BLACK_COLOR,1,0xffff);
	
		//unsigned short const Thai_Font17_Pic_15[];   ////15：取消 ??????
		Thai_Draw(Thai_Font17_Pic_15,PUSH_RESET_CANCEL_X,PUSH_RESET_CANCEL_Y,BLACK_COLOR,1,0xffff);
	 break;
	case VIETNAMESE://越南语
		// vietnam_print((unsigned char *)Viet_Font24_Pic_TZQ,PUSH_RESET_PROMPT_X1+80,PUSH_RESET_PROMPT_Y1+5,BLACK_COLOR,1,0xffff);
		vietnam_print((unsigned char *)Viet_Font24_Pic_14,PUSH_RESET_OK_X,PUSH_RESET_OK_Y,BLACK_COLOR,1,0xffff);
		vietnam_print((unsigned char *)Viet_Font24_Pic_15,PUSH_RESET_CANCEL_X,PUSH_RESET_CANCEL_Y,BLACK_COLOR,1,0xffff);
		break;
	}	
}
...
switch(Language)
	...
	case THAILAND:
		//unsigned short const Thai_Font17_Pic_54[];   ////54：请输入密码 ?????????????
		Thai_Draw(Thai_Font17_Pic_54,x,y,BLACK_COLOR,0,0xffff);
	 break;
	case VIETNAMESE://越南语
		vietnam_print((unsigned char *)Viet_Font24_Pic_54,x,y,BLACK_COLOR,0,0xffff);
	 break;
	}
...
void yuandianSensorInMachine_dis(Int8U down_flag)//原点 传感器位置 示意
{
Int16U x,y,color;
Int8U r=3;
x=505,y=266;
