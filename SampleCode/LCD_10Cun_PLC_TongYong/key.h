...
#define LINE_SEL_KEY_CODE      0xffff1019//touch line select
//------------时间框位置
#define Tx_1  50
#define Ty_1  2 
#define SpaceX  50
...
// ---------passcode
#define PASS_MOD_CODE		687610 //密码模式 
#define PASSCODE_formula(code)  (code*2+2)  //密码算法
#define PASSCODE_forSupermula(code)  (code*3-3)  //密码算法
...
extern    unsigned char cursor_pro;
...
extern Int32U SuperPassCode;
extern Int32U PassCheck;
...
void ReadAutoPressWork_TimeSet(void);
