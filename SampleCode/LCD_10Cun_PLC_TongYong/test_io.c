	...
	case 1:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("Origin",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
case THAILAND:
	...
	case 2:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("Cutter",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 3:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("Press",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 4:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("Plate",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	 ...
	 break;
	       ...
	       break;
	case 5:
		Printf24("IR",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 6:
	...
	case 11:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("F-limit",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 12:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("M-limit",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 13:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("B-limit",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 14:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("Handwheel",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
...
switch(num)
	...
	//ASCII_Printf("IN0",ASCII1632_MODE,ASCII1632_WIDTH,ASCII1632_HIGH,ASCII1632,Xp,Yp,0);
	       break;
	case 1:
		Printf24("Orig",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 2:
		Printf24("Cut",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 3:
		Printf24("Press",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 4:
		Printf24("Plate",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 5:
		Printf24("IR",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 6:
	...
	case 10:
		Printf24("10",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 11:
		Printf24("F-lim",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 12:
		Printf24("M-lim",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 13:
		Printf24("B-lim",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 14:
		Printf24("Weel",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 15:
	//ASCII_Printf("IN15",ASCII1632_MODE,ASCII1632_WIDTH,ASCII1632_HIGH,ASCII1632,Xp,Yp,0);
	       break;
...
switch(num)
	...
	case 16:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Entr",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	 ...
	 break;
	       ...
	       break;	   
	case 17:
		Printf24("X",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 18:
		Printf24("/",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 19:
		Printf24("PgUP",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 20:
		Printf24("PgDn",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 21:
		Printf24("Push",Xp,Yp,BLACK_COLOR,0,0xffff);//Jostle
	       break;
	case 22:
		Printf24("Inse",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 23:
		Printf24("Del",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 24:
		Printf24("Mend",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 25:
		Printf24("Up",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 26:
		Printf24("Down",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 27:
		Printf24("Left",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 28:
		Printf24("Rigt",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 29:
		if(WorkStart_flag==0)
		Printf24("Shift",Xp,Yp,BLACK_COLOR,0,0xffff);
		else
			Printf24("Shft",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 30:
		switch(Language)
				{
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Prog",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 31:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Auto",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 32:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Manu",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 33:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Proc",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 39:
		Printf24("F6",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 40:  
		Printf24("Help",Xp,Yp,BLACK_COLOR,0,0xffff);     //返回帮助---
		if(WorkStart_flag==0)
			{
		if(Keydown==1)
			{
	...
	case 41:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Run",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 42:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Stop",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 43:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Back",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 44:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("F-Bk",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 45:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("F-Fd",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
	...
	case 46:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf24("Fwd",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				case THAILAND:
