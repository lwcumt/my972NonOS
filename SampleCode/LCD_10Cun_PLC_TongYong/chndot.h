...
extern unsigned char const ASCII_1632_KAITI[];
...
extern unsigned char const ARROW_ZM16_32[];
...
//屏幕输出指定大小字体的ASCII字符串
void ASCII_Printf_OneChar_NoFill(char *asc,int dotmode,int dotwidth,int dothigh,unsigned char const *dot,int x,int y, int color);
