...
#define  PIC_DIS_SAVE5		(PIC_DIS_SAVE4+0x00100000)//0x8167d000    //当前显示区块 暂存区4

#define  df_zk_sdram        (PIC_DIS_SAVE5+0x00100000)// 0x81880000            //0x81700000字库2M
...
//压力设置
#define PRESSURE_SET_Set_sdram (SCHEDULE_sdram+32768)

//电气 控制信号
#define  POWER_SWITCH_BUTT_SIZE    8192
#define  POWER_ON_UP_sdram   (PRESSURE_SET_Set_sdram+POWER_SWITCH_BUTT_SIZE)	//电源绿up
...
#define	 RED_KNIFE_BUTT_sdram	(FAST_BACK_UP_sdram+JOG_BUTT_SIZE) //红刀 按钮
...
//--------
#define  RUN_BUTT_SIZE		JOG_BUTT_SIZE//5456
...
//******************标记显示  图标
#define FLAG_PIC_WIDE	30//40
#define FLAG_PIC_HIGH	25
//红刀	标志pic
#define  RED_KNIFE_PIC_X	345//340
...
//气垫pic
#define  AIR_FLAG_PIC_X		(RED_KNIFE_PIC_X-50)
...
#define  PROG_Y		120-4//110
//"步骤"
#define  STEP_X		(PROG_X+140)//(PROG_X+180)
#define  STEP_Y		PROG_Y
//程序号
#define  PROG_NUM_X		(PROG_X+100-24)//120
#define  PROG_NUM_Y		PROG_Y
//步骤号
#define  STEP_NUM_X		(STEP_X+100-24)//120
...
//------- 刀  &压纸  pic
//刀上
#define  KNIFE_UP_X		350//380
#define  KNIFE_UP_Y		15//480
//刀下
...
//---------------------------------
//F4---标记 设定按钮
#define ALL_FLAG_WIN_BASE_X		400//380
#define ALL_FLAG_WIN_BASE_Y		160//520
...
//------------------------------
//-停止-- 按钮
#define RUN_BUTT_WIDE	70//60
#define RUN_BUTT_HIGH	45//26
#define STOP_X		(TEACH_BUTT_X+90)//(AUTOCUT_BUTT_X+85)
#define STOP_Y		490//AUTOCUT_BUTT_Y
//jog
#define JOG_BUTT_WIDE	70//75
#define JOG_BUTT_HIGH	45//35
//后退up
#define	 BACK_PAGE_X	400//RUN_BUTT_X
#define	 BACK_PAGE_Y	STOP_Y//490//KNIFE_UP_Y
//快退
#define	 FAST_BACK_X	(BACK_PAGE_X+80)
#define	 FAST_BACK_Y	BACK_PAGE_Y
//前进
#define	 FRONT_PAGE_X	(FAST_BACK_X+80)
#define	 FRONT_PAGE_Y	BACK_PAGE_Y
//快进
#define	 FAST_FWD_X		(FRONT_PAGE_X+80)
#define	 FAST_FWD_Y		BACK_PAGE_Y

//运行--up
#define  RUN_BUTT_X		(FAST_FWD_X+80)//(RUN_BUTT_X+95)
#define  RUN_BUTT_Y		STOP_Y
...
#define  PRO_UP_ARROW_X	 STOP_X//320				//F3 程序下
#define  PRO_UP_ARROW_Y	 STOP_Y//(MIDDLE_PAGE_Y+M_PAGE_HIGH-50)
//子菜单 向下
...
#define PRO_RIGHT_ARROW_Y 	(F3_PRO_CAPTION_Y+15)//20
...
#define PROC_NAME_Y	(PROC_NUM_Y+5)
...
//F2------------参数页
#define PARA_START_X1		(MIDDLE_PAGE_X+5) //80
#define PARA_START_X2		205//240
#define PARA_START_Y		(MIDDLE_PAGE_Y+8)//210
#define PARA_COL_WIDE		245//350
#define PARA_ROW_GAP		35//40
#define PARA_TAB_WIDE		(PARA_COL_WIDE<<1)//490

//----------F3时钟 数据页
#define CLOCK_DATA_X	(MIDDLE_PAGE_X+35)//120
#define CLOCK_DATA_Y	(MIDDLE_PAGE_Y+20)//240	
#define CLOCK_GAP_Y		40//PARA_ROW_GAP	
...
//刀，压纸sensor 位置示意
#define KNIFE_SENSOR_X	231//235//190
#define KNIFE_SENSOR_Y	199//365//262
#define PRESS_SENSOR_X	400//520//410
#define PRESS_SENSOR_Y	205//307//220
//******自刀提示
...
extern uint16_t Setting_User_Count[2];//设置的使用次数
...
extern Int16U AutoModeKnifeOrder_temp;
