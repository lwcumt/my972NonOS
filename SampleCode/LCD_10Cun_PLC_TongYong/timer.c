...
unsigned int const waitTb5[]={
	...
	0xDCE2, 0xDD54, 0xDDC2, 0xDE28, 0xDE91, 0xDEF8, 0xDF56, 0xDFB9, 0xE019, 0xE071,  // 40
	0xE0CC, 0xE126, 0xE179, 0xE1CF, 0xE223, 0xE270, 0xE2C0, 0xE30F, 0xE358, 0xE3A4,  // 50
	0xE3EE, 0xEA13, 0xEE05, 0xF0C4, 0xF2C8, 0xF454, 0xF58E, 0xF68C, 0xF75E, 0xF80F,  // 60
	0xF8A6, 0xF928, 0xF999, 0xF9FD, 0xFA55, 0xFAA4, 0xFAEB, 0xFB2A, 0xFB64, 0xFB99,  // 70
	0xFBCA, 0xFBF6, 0xFC1F, 0xFC45, 0xFC68, 0xFC88, 0xFCA7, 0xFCC3, 0xFCDE, 0xFCF7,  // 80
...
//	0xFD0F, 0xFD25, 0xFD3A, 0xFD4D, 0xFD60, 0xFD72, 0xFD83, 0xFD93, 0xFDA2, 0xFDB0,  // 90
	//0xFDBE, 0xFDCC, 0xFDD8, 0xFDE4, 0xFDF0, 0xFDFB, 0xFE06, 0xFE10, 0xFE1A, 0xFE23,  // 100
//	0xFE2C, 0xFE35, 0xFE3D, 0xFE45, 0xFE4C, 0xFE53, 0xFE5A, 0xFE61, 0xFE68, 0xFE6E,  // 110
	//0xFE74, 0xFE7A, 0xFE80, 0xFE86, 0xFE8B, 0xFE91, 0xFE96, 0xFE9B, 0xFEA0, 0xFEA4 // 120
...
unsigned int const waitTb6[]={
	...
	//0xFD3D, 0xFD51, 0xFD65, 0xFD78, 0xFD8A, 0xFD9A, 0xFDAA, 0xFDB9, 0xFDC8, 0xFDD6,  // 90
//	0xFDE3, 0xFDEF, 0xFDFB, 0xFE07, 0xFE11, 0xFE1C, 0xFE26, 0xFE30, 0xFE39, 0xFE42,  // 100
//	0xFE4B, 0xFE53, 0xFE5C, 0xFE64, 0xFE6B, 0xFE73, 0xFE7A, 0xFE81, 0xFE88, 0xFE8E,  // 110
	//0xFE95, 0xFE9B, 0xFEA1, 0xFEA6, 0xFEAC, 0xFEB1, 0xFEB7, 0xFEBC, 0xFEC0, 0xFEC5 // 120
...
///	0xFE7C, 0xFE83, 0xFE8A, 0xFE91, 0xFE97, 0xFE9D, 0xFEA3, 0xFEA8, 0xFEAE, 0xFEB3,  // 110
 //	0xFEB8, 0xFEBD, 0xFEC2, 0xFEC7, 0xFECB, 0xFED0, 0xFED4, 0xFED8, 0xFEDD, 0xFEE0 // 120
...
unsigned int const waitTb8[]={
	...
	/*
	0xC7C7, 0xC872, 0xC908, 0xC99B, 0xCA2B, 0xCAC8, 0xCB52, 0xCBD9, 0xCC5E, 0xCCEE,  // 10
	0xCD6E, 0xCDEA, 0xCE65, 0xCEEA, 0xCF5F, 0xCFD3, 0xD044, 0xD0C0, 0xD12C, 0xD198,  // 20
	0xD20C, 0xD273, 0xD2D9, 0xD33C, 0xD3A9, 0xD409, 0xD467, 0xD4C4, 0xD52A, 0xD583,  // 30
	0xD5DB, 0xD632, 0xD691, 0xD6E5, 0xD738, 0xD789, 0xD7E2, 0xD830, 0xD87E, 0xD8CA,  // 40
	0xD91E, 0xD968, 0xD9B1, 0xD9F8, 0xDA47, 0xDA8C, 0xDAD1, 0xDB1C, 0xDB5F, 0xDBA0,  // 50
	0xDBE1, 0xDC28, 0xDC67, 0xDCA5, 0xDCE2, 0xDD25, 0xDD61, 0xDD9B, 0xDDD5, 0xDE15,  // 60
	0xDE4D, 0xDE85, 0xDEBC, 0xDEF8, 0xDF2D, 0xDF62, 0xDF96, 0xDFCF, 0xE002, 0xE034,  // 70
	0xE066, 0xE09C, 0xE0CC, 0xE0FC, 0xE131, 0xE15F, 0xE18D, 0xE1BB, 0xE1EC, 0xE219,  // 80
	
	
	
	
	0xE066, 0xE09C, 0xE0CC, 0xE0FC, 0xE131, 0xE15F, 0xE18D, 0xE1BB, 0xE1EC, 0xE219,  // 90
	
	
	
	0xE3EE, 0xF787, 0xFB07, 0xFC7D, 0xFD4B, 0xFDCC, 0xFE26, 0xFE67, 0xFE99, 0xFEC1,  // 100
...
unsigned int const waitTb9[]={
	...
	0xE245, 0xE270, 0xE2A0, 0xE2CA, 0xE2F4, 0xE31D, 0xE34B, 0xE373, 0xE39B, 0xE3C2,  // 90
	
	
	0xE3EE, 0xF803, 0xFB5C, 0xFCBD, 0xFD7E, 0xFDF7, 0xFE4B, 0xFE87, 0xFEB6, 0xFEDA,  // 100
...
unsigned int const waitTb10[]={
	...
	0xE3EE, 0xF873, 0xFBA8, 0xFCF5, 0xFDAA, 0xFE1C, 0xFE6A, 0xFEA3, 0xFECE, 0xFEF0,  // 100
...
/*	
	...
	0xE066, 0xE09C, 0xE0CC, 0xE0FC, 0xE131, 0xE15F, 0xE18D, 0xE1BB, 0xE1EC, 0xE219,  // 80
	0xE245, 0xE270, 0xE2A0, 0xE2CA, 0xE2F4, 0xE31D, 0xE34B, 0xE373, 0xE39B, 0xE3C2,  // 90
	0xE3EE, 0xF8D6, 0xFBEA, 0xFD26, 0xFDD1, 0xFE3C, 0xFE85, 0xFEBA, 0xFEE3, 0xFF03,  // 100
...
unsigned int const waitTb12[]={
	...
	0xE066, 0xE09C, 0xE0CC, 0xE0FC, 0xE131, 0xE15F, 0xE18D, 0xE1BB, 0xE1EC, 0xE219,  // 80
	0xE245, 0xE270, 0xE2A0, 0xE2CA, 0xE2F4, 0xE31D, 0xE34B, 0xE373, 0xE39B, 0xE3C2,  // 90
	0xE3EE, 0xF930, 0xFC24, 0xFD51, 0xFDF3, 0xFE58, 0xFE9D, 0xFECF, 0xFEF5, 0xFF13,  // 100
 ...
 ////*******************************************
   switch(MotorType)
	...
	case MOTOR_FREQ_3_SPD_RST:
				...
				{
					xz=1;
					if(StartCheck_mode==16)//xxxxxxxxxxxxxx20200328
						{
						MoveStop();
				...
				#ifdef PLC_3U 
				if(Ori_Sensor_Status)   //如果第一路光藕输入为高?
						{   
							 senor=1;
							 xsenor1=1;
						}
		   ...
		   if(xa==0&&xb==0)
			 {
			  if(xa1==0&&xb1==1)
				{ 
//				if(muqiancn>(FrontLimit+maichongdangliang))
					{
				qianjin=1;
				  houtui=0; 
				 muqiancn=muqiancn-maichongdangliang;
			...
			if(ToTargetStop_flag==0)
				...
				if(Backward_flag==1)     //后退
					...
					//	}
						...
						//已取消提前量
					if(CurrentSize<TargetSize)    //停止运行//if(CurrentSize<TargetSize+Aheader)    //停止运行
						{
						MoveStop();
						Forward_flag=0;
						Run_flag=0;
			...
			if(1)		//20191115
				...
				//if(flagshoulun==0) 
					...
					if(xa==0&&xb==1)
					   ...
					   if(xa1==1&&xb1==1)
						 {   
					if(CurrentSize>(FrontLimit))//+maichongdangliang))
								{							 
								InTargetPosit_flag=0;
								if(MotorType==MOTOR_AC_SERVO)
									M_DOUT_ON ;
...
//////////			{
//////////				if(Machine_Set_UserCount_Time<10000)
//////////					Machine_Set_UserCount_Time++;
//////////			}
//////////			
//////////	 SysTime++;
//////////        
...
//	ms_t++;
	...
	//	Limit_Sensor_Get_Status();//从板载IO或PLC上获取状态		//放到定时中断里检测	
	



		
	//	App_Yiten_CommPollExec();
		#ifdef PLC_3U
		App_Modbus_Test_Task();	
	
		
	ModBus_Comm_Check_Recv_TimeOut();//MODBUS 接收超时检测			
	
	
	#endif
	
						
	//	App_Modbus_Servo_TimeOut();//伺服通讯超时检测   //放在Modbus Task里 202308
//	App_Modbus_PLC_TimeOut();//PLC 通讯超时检测
		
	//App_FX_Plc_TimeOut_Exec();//调用FX_PLC超时
  ...
  if( flaglaba==1)
   ...
   if(CutEnBegin_flag==1)
			{
			CutDelayTime++;
			if(CutDelayTime>800+AutoPressWork_TimeSet*250)
				{
				CutEnBegin_flag=0;
				BellOUT_OFF;
				RLOUT4_ON;
...
void Timer2Disable(void)  //定时器1禁止
{
