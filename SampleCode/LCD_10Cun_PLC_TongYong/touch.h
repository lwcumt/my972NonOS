...
//*****************************
//---上翻页
#define  PAGE_UP_BUTTON_X1	(SCHEDULE_X-BUTT_Y_EXT10)
#define  PAGE_UP_BUTTON_Y1	(SCHEDULE_Y-10)
#define  PAGE_UP_BUTTON_X2	(SCHEDULE_X+SCHEDULE_WIDE+BUTT_Y_EXT10)
...
#define  PAGE_DOWN_BUTTON_Y2	(SCHEDULE_Y+SCHEDULE_HIGH+BUTT_Y_EXT10)
//向上-------------------<
...
// #define INPUT_Y2		C_GLCD_V_SIZE//600//(SIZE_WINDOW_Y+SIZE_WINDOW_HIGH+BUTT_Y_EXT2)
//shift 按钮
...
//子菜单 插入
#define INSERT_X1		(L_R_ARROW_X-BUTT_Y_EXT2)
#define INSERT_Y1		(L_R_ARROW_Y-BUTT_Y_EXT2)
#define INSERT_X2		(L_R_ARROW_X+F1_4_WIDE+BUTT_Y_EXT2)
#define INSERT_Y2		(L_R_ARROW_Y+F1_4_HIGH+BUTT_Y_EXT2)
...
//程序名下
#define PRO_UP_TO_X1		(PRO_UP_ARROW_X-BUTT_Y_EXT2)
...
//程序名下
#define PRO_DOWN_TO_X1		(PRO_DOWN_ARROW_X-BUTT_Y_EXT2)
...
// //S1 压纸 按钮
#define FLAG_S1_X1	F2_PRE_PAPER_X
#define FLAG_S1_Y1	FLAG_S0_Y1
#define FLAG_S1_X2	(F2_PRE_PAPER_X+FLAG_WIDE)
#define FLAG_S1_Y2	FLAG_S0_Y2
// //S2 理纸 按钮
#define FLAG_S2_X1	F3_SORT_PAPER_X
#define FLAG_S2_Y1	FLAG_S0_Y1
#define FLAG_S2_X2	(F3_SORT_PAPER_X+FLAG_WIDE)
#define FLAG_S2_Y2	 FLAG_S0_Y2
// //S3推纸标志 按钮
#define FLAG_S3_X1	F4_PUSH_PAPER_X
#define FLAG_S3_Y1	FLAG_S0_Y1
#define FLAG_S3_X2	(F4_PUSH_PAPER_X+FLAG_WIDE)
#define FLAG_S3_Y2	FLAG_S0_Y2
// //S4 红刀  按钮
#define FLAG_S4_X1	F5_RED_KNIFE_X
#define FLAG_S4_Y1	FLAG_S0_Y1
#define FLAG_S4_X2	(F5_RED_KNIFE_X+FLAG_WIDE)
#define FLAG_S4_Y2	FLAG_S0_Y2
// //S5 批量刀  按钮
#define FLAG_S5_X1	S5_ALL_KNIFE_X
#define FLAG_S5_Y1	FLAG_S0_Y1
#define FLAG_S5_X2	(S5_ALL_KNIFE_X+FLAG_WIDE)
#define FLAG_S5_Y2	FLAG_S0_Y2
****/

//气垫 按钮------aaaaaa
#define AIR_FLAG_BUTT_X1	(F1_AIR_BASE_X-30)
#define AIR_FLAG_BUTT_Y1	(F1_AIR_BASE_Y-5)
#define AIR_FLAG_BUTT_X2	(F1_AIR_BASE_X+AIR_FLAG_WIDE+15)
#define AIR_FLAG_BUTT_Y2	(F1_AIR_BASE_Y+AIR_FLAG_HIGH+5)
//其他 按钮------bbbbbbb
#define OTHER_FLAG_BUTT_X1	(ALL_FLAG_BASE_X-15)
#define OTHER_FLAG_BUTT_Y1	AIR_FLAG_BUTT_Y1	//(ALL_FLAG_BASE_Y-5)
#define OTHER_FLAG_BUTT_X2	(ALL_FLAG_BASE_X+AIR_FLAG_WIDE+30)
#define OTHER_FLAG_BUTT_Y2	AIR_FLAG_BUTT_Y2	//(ALL_FLAG_BASE_Y+AIR_FLAG_WIDE+5)
//-----列表行选择
#define LINE_SEL_BASE_BUTT_X1 RIGHT_ARROW_X
#define LINE_SEL_BASE_BUTT_Y1 AIR_FLAG_BUTT_Y1
#define LINE_SEL_BASE_BUTT_X2 OTHER_FLAG_BUTT_X2
#define LINE_SEL_BASE_BUTT_Y2 AIR_FLAG_BUTT_Y2
//----弹出Wind内按钮-------------
//S1推纸标志 按钮
#define PUSH_FLAG_BUTT_X1	S1_PUSH_PAPER_X
#define PUSH_FLAG_BUTT_Y1	S1_PUSH_PAPER_Y
#define PUSH_FLAG_BUTT_X2	(S1_PUSH_PAPER_X+ALL_FLAG_BUTT_WIDE)
#define PUSH_FLAG_BUTT_Y2	(S1_PUSH_PAPER_Y+ALL_FLAG_BUTT_HIGH)
// S2 理纸 按钮
#define	SORT_FLAG_BUTT_X1 	S2_SORT_PAPER_X
#define SORT_FLAG_BUTT_Y1	S2_SORT_PAPER_Y
#define	SORT_FLAG_BUTT_X2 	(S2_SORT_PAPER_X+ALL_FLAG_BUTT_WIDE)
#define SORT_FLAG_BUTT_Y2	(S2_SORT_PAPER_Y+ALL_FLAG_BUTT_HIGH)
// S3 压纸 按钮
#define	PRESS_FLAG_BUTT_X1	S3_PRE_PAPER_X
#define PRESS_FLAG_BUTT_Y1	S3_PRE_PAPER_Y
#define	PRESS_FLAG_BUTT_X2	(S3_PRE_PAPER_X+ALL_FLAG_BUTT_WIDE)
#define PRESS_FLAG_BUTT_Y2	(S3_PRE_PAPER_Y+ALL_FLAG_BUTT_HIGH)
// S4 红刀  按钮
#define	KNIFE_FLAG_BUTT_X1	S4_RED_KNIFE_X
#define	KNIFE_FLAG_BUTT_Y1	S4_RED_KNIFE_Y
#define	KNIFE_FLAG_BUTT_X2	(S4_RED_KNIFE_X+ALL_FLAG_BUTT_WIDE)
#define	KNIFE_FLAG_BUTT_Y2	(S4_RED_KNIFE_Y+ALL_FLAG_BUTT_HIGH)	
// S5 所有刀  按钮
#define	KNIFES_FLAG_BUTT_X1	S5_ALL_KNIFE_X	
#define	KNIFES_FLAG_BUTT_Y1	S5_ALL_KNIFE_Y	
#define	KNIFES_FLAG_BUTT_X2	(S5_ALL_KNIFE_X+ALL_FLAG_BUTT_WIDE)	
#define	KNIFES_FLAG_BUTT_Y2	(S5_ALL_KNIFE_Y+ALL_FLAG_BUTT_HIGH)
// S6 清除其他标记  按钮
#define	CLR_FLG_BUTT_X1	S6_CLR_FLG_X
#define	CLR_FLG_BUTT_Y1	S6_CLR_FLG_Y
#define	CLR_FLG_BUTT_X2	(S6_CLR_FLG_X+ALL_FLAG_BUTT_WIDE)
#define	CLR_FLG_BUTT_Y2	(S6_CLR_FLG_Y+ALL_FLAG_BUTT_HIGH)
//F2 退出wind
#define	EXIT_FLAG_BUTT_X1	F2_CLOSE_FLAG_WIN_X
#define	EXIT_FLAG_BUTT_Y1	F2_CLOSE_FLAG_WIN_Y
#define	EXIT_FLAG_BUTT_X2	(F2_CLOSE_FLAG_WIN_X+F2_CLOSE_FLAG_WIN_WIDE)
#define	EXIT_FLAG_BUTT_Y2	(F2_CLOSE_FLAG_WIN_Y+F2_CLOSE_FLAG_WIN_HIGH)
...
#define PRO_NUM_TABLE_X1	LINE_SEL_BASE_BUTT_X1
#define PRO_NUM_TABLE_Y1	PROC_NUM_Y
#define PRO_NUM_TABLE_X2	(PROC_DATE_X+100)
#define PRO_NUM_TABLE_Y2	(PRO_NUM_TABLE_Y1+PROTEXT_HIGH)

#define SET_DATA_ITEM_X1	(PARA_START_X2-30)
#define SET_DATA_ITEM_Y1	MIDDLE_PAGE_Y
#define SET_DATA_ITEM_X2	(MIDDLE_PAGE_X+PARA_TAB_WIDE/2-10)
#define SET_DATA_ITEM_Y2	(SET_DATA_ITEM_Y1+PARA_ROW_GAP)

#define SET_TIME_ITEM_X1	(CLOCK_DATA_X+60)
#define SET_TIME_ITEM_Y1	CLOCK_DATA_Y
#define SET_TIME_ITEM_X2	(SET_TIME_ITEM_X1+150)
#define SET_TIME_ITEM_Y2	(CLOCK_DATA_Y+CLOCK_GAP_Y)

extern Int8U Touch_down_flag; 

extern Int32U Touch_code;
extern Int32U Touch_code_temp;
extern TOUCH Touch_Pos;
extern Int8U FlagTouRow_num;
extern Int8U TouchLnie_num;
