 ...
 * @brief    NUC970 series ETIMER driver source file
 *
 * @note
...
static UINT ETIMER_GetModuleClock(UINT timer)
{
    ...
    if(src == 0)
        ...
        return (sysGetClock(SYS_PCLK)*1000000);		//++20180313
    else if (src == 2)
...
/** @addtogroup NUC970_ETIMER_Driver ETIMER Driver
  @{
*/


/** @addtogroup NUC970_ETIMER_EXPORTED_FUNCTIONS ETIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC970_ETIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC970_ETIMER_Driver */
