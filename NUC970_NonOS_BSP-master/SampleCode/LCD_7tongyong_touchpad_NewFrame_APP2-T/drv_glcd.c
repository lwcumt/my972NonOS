...
Int32U i;
	/*
for( Int32U i = 0; i<C_GLCD_H_SIZE*C_GLCD_V_SIZE*2; i++)
*( Int16U *)(LCD_VRAM_BASE_ADDR + i) = 0xffff;
*/
...
/*
for( Int32U i = 0; i<C_GLCD_H_SIZE*C_GLCD_V_SIZE*2; i++)
*( Int16U *)(LCD_VRAM_BASE_ADDR + i) = color;
*/
   pInt16U p = (pInt16U) malloc(sizeof(Int16U) * C_GLCD_V_SIZE); 
   for(  i = 0; i<C_GLCD_V_SIZE; i++)
   p[i]=color;
 ...
 void PutPixel(Int32U x,Int32U y,Int16U color)
{
    if(x < C_GLCD_H_SIZE && y < C_GLCD_V_SIZE)
      *( Int16U *)(LCD_VRAM_BASE_ADDR + x * 2 + 2*C_GLCD_H_SIZE* y) = color;
}
...
//	Int32U Ch1;
	...
	pInt16U char_wr_ptr = (pInt16U)SDRAM0_BASE_ADDR;
	...
	for(j=0; j<16; j++)
	{
		...
		StartY++;
		char_wr_ptr = (pInt16U)SDRAM0_BASE_ADDR;
		char_wr_ptr = char_wr_ptr + (StartY-1)*C_GLCD_V_SIZE + StartX - 1;			
	}	
}
...
void LCD_PutHz(pInt8U HzData,Int32U StartX,Int32U StartY,Int32U LineColor,Int32U FillColor)
{
	...
	Int32U temp;
	pInt16U char_wr_ptr;
	char_wr_ptr =(pInt16U)( SDRAM0_BASE_ADDR + (StartY*C_GLCD_H_SIZE + StartX)*2);
