...
//
#define BUTT_WIDE	50//42
#define BUTT_HIGH	48//45
#define BUTT_GAP_X	5
#define BUTT_GAP_Y	5
#define BUTT_X1		(CALCUL_WIN_X+15)
...
//提示框
#define  REMIND_WINDOW_X	260//160
#define  REMIND_WINDOW_Y	710//690
...
//示教button
#define  TEACH_BUTT_X	(PUSH_BUTT_X+80)
...
//---------------------------------
//F4---标记 设定按钮
#define ALL_FLAG_WIN_BASE_X		480//965
#define ALL_FLAG_WIN_BASE_Y		650//215
#define FLAG_WIDE		32
#define FLAG_HIGH		42
#define FLAG_BUTT_GAPX		(FLAG_WIDE+15)//70
#define FLAG_BUTT_GAPY		0//(FLAG_HIGH+12)
#define ALL_FLAG_WIN_WIDE	(FLAG_BUTT_GAPX*6)
#define ALL_FLAG_WIN_HIGH	FLAG_HIGH
//F1 气垫 按钮
