...
switch(num)
	...
	case 13:
		Printf24("B-lim",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 14:
		Printf24("Han-W",Xp,Yp,BLACK_COLOR,1,Colar);
	       break;
	case 15:
	//ASCII_Printf("IN15",ASCII1632_MODE,ASCII1632_WIDTH,ASCII1632_HIGH,ASCII1632,Xp,Yp,0);
	       break;
...
switch(num)
	...
	case 16:
		switch(Language)
				...
				Printf24("确定",Xp,Yp,BLACK_COLOR,0,0xffff);
			       break;	   
				default:
					Printf24("Enter",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
	       break;	   
	case 17:
	...
	case 19:
		Printf24("PgUP",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 20:
		Printf24("PgDwn",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 21:
		Printf24("Push",Xp,Yp,BLACK_COLOR,0,0xffff);//Jostle
	       break;
	case 22:
		Printf24("Inset",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 23:
	...
	case 27:
		Printf24("Left",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 28:
		Printf24("Right",Xp,Yp,BLACK_COLOR,0,0xffff);
	       break;
	case 29:
		if(WorkStart_flag==0)
		...
		switch(Language)
				...
				case CHN_HAN:
					Printf24("程序",Xp,Yp,BLACK_COLOR,0,0xffff);
				       break;
				default:
					Printf24("Proce",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
	       break;
		...
		switch(Language)
				...
				case CHN_HAN:
					Printf24("运行",Xp,Yp,BLACK_COLOR,0,0xffff);
				       break;
				default:
					Printf16("Run",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
	       break;
	case 42:
		switch(Language)
				...
				case CHN_HAN:
					Printf24("停止",Xp,Yp,BLACK_COLOR,0,0xffff);
				       break;	   
				default:
					Printf16("Stop",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
	       break;	   
	case 43:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("Back",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
		if(Keydown==1)
			{
	...
	case 44:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("F-Back",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
		if(Keydown==1)
			{
	...
	case 45:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("F-Fwd",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
		if(Keydown==1)
			{
	...
	case 46:
		switch(Language)
				...
				case CHN_HAN:
					...
					break;
				default:
					Printf16("Fwd",Xp,Yp,BLACK_COLOR,0,0xffff);
					break;
				}
		if(Keydown==1)
			{
