...
//-------计算器 弹出框
#define CALCUL_WIN_X	765//370
#define CALCUL_WIN_Y	210//160
#define CALCUL_WIDE		182//472
#define CALCUL_HIGH		330//405
#define CALCUL_COLOR	0x879e

#define CALCUL_TEXT_X	(CALCUL_WIN_X+5)
#define CALCUL_TEXT_Y	(CALCUL_WIN_Y+5)
#define CALCUL_TEXT_H	25//30
#define CALCUL_TEXT_W	175//450
#define CALCUL_TEXT_END	(CALCUL_TEXT_X+CALCUL_TEXT_W)//-12)

#define CALCUL_RESULT_X	(CALCUL_TEXT_X+10)//160)
#define CALCUL_RESULT_Y	(CALCUL_TEXT_Y+CALCUL_TEXT_H+5)
#define CALCUL_RESULT_H	CALCUL_TEXT_H//30
#define CALCUL_RESULT_W	(CALCUL_TEXT_W-10)//275
//
#define BUTT_WIDE	40//75
#define BUTT_HIGH	42//60
#define BUTT_GAP_X	5
#define BUTT_GAP_Y	5
...
#define BUTT_Y1		(CALCUL_RESULT_Y+25+5)
...
//进度条
#define  SCHEDULE_X		700//870
#define  SCHEDULE_Y		215//170//120
...
//******************标记显示  图标
#define FLAG_PIC_WIDE	60
#define FLAG_PIC_HIGH	35
//红刀	标志pic
#define  RED_KNIFE_PIC_X	350//350
...
//************************************工作图标
//"程序"
#define  PROG_X		120//75
#define  PROG_Y		145//110
//"步骤"
#define  STEP_X		(PROG_X+160)//(PROG_X+180)
...
//程序名
#define  PRO_NAME_DIS_COLOR	0x080f //0x12bc
#define  PRO_NAME_DIS_X		105//45
#define  PRO_NAME_DIS_Y		75//35
//******************尺寸显示
//当前尺寸 显示位置
#define CURR_SIZE_X		530//590
#define CURR_SIZE_Y		80//50
//刀前 显示位置
#define  FRONT_KNIFE_X	540//620
#define  FRONT_KNIFE_Y	135//61
...
//------- 刀  &压纸  pic
//刀上
#define  KNIFE_UP_X		500//450//
#define  KNIFE_UP_Y		615//
//刀下
...
//--------------功能ICON--------------------
//标签功能
#define	LABEL_FUN_PIC_X		480//420
...
#define	 AUTO_BUTT_Y		670//自动mod按钮
...
#define  F1_BUTTON_X		30//956
#define  F1_BUTTON_Y		200  //F1标签按钮
...
//---------------------------------
//F4---标记 设定按钮
#define ALL_FLAG_WIN_BASE_X		960//520
#define ALL_FLAG_WIN_BASE_Y		215//260
#define FLAG_WIDE		32
#define FLAG_HIGH		42
// #define FLAG_BUTT_GAPX		70//62
#define FLAG_BUTT_GAPY		(FLAG_HIGH+12)//52
#define ALL_FLAG_WIN_WIDE	FLAG_WIDE//183
#define ALL_FLAG_WIN_HIGH	(FLAG_BUTT_GAPY*6)//108
//F1 气垫 按钮
#define F1_AIR_BED_X	(ALL_FLAG_WIN_BASE_X+0)
#define F1_AIR_BED_Y	(ALL_FLAG_WIN_BASE_Y+0)
// F2 压纸 按钮
#define	 F2_PRE_PAPER_X	F1_AIR_BED_X
#define  F2_PRE_PAPER_Y	(F1_AIR_BED_Y+FLAG_BUTT_GAPY)
// F3 理纸 按钮
#define	 F3_SORT_PAPER_X	F1_AIR_BED_X
...
// F5 红刀  按钮
#define	 F5_RED_KNIFE_X		F1_AIR_BED_X
#define	 F5_RED_KNIFE_Y		(F4_PUSH_PAPER_Y+FLAG_BUTT_GAPY)
// S5 所有刀  按钮
#define	 S5_ALL_KNIFE_X		F1_AIR_BED_X
...
#define RUN_BUTT_X		(AUTOCUT_BUTT_X+110)
#define RUN_BUTT_Y		AUTOCUT_BUTT_Y
//停止up
#define  STOP_X		(RUN_BUTT_X+120)
#define  STOP_Y		RUN_BUTT_Y

#define JOG_BUTT_WIDE	80
#define JOG_BUTT_HIGH	40
//后退up
#define	 BACK_PAGE_X	RUN_BUTT_X//500
#define	 BACK_PAGE_Y	620//
//快退
...
#define PARA_START_X2		240//230
#define PARA_START_Y		MIDDLE_PAGE_Y//210
#define PARA_COL_WIDE		400//350
#define PARA_ROW_GAP		40//50
...
#define KNIFE_SENSOR_Y	318//365
#define PRESS_SENSOR_X	448//520
#define PRESS_SENSOR_Y	270//307
//******自刀提示
