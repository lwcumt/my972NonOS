	...
	case NUMBER_INPUT:
		switch(Language)
			...
			case INDONSIA:	//印尼
				...
				break;
			case FRENCH:	//法语	
				Printf24("NUMERO-SAISIE ",x,y,line_color,0,fill_color);
				Printf24("NUMERO",x,y,line_color,1,fill_color);
				break;
			}
		break;
	case CHAR_INPUT:
		switch(Language)
			...
			case INDONSIA:	//印尼
				...
				break;
			case FRENCH:	//法语	
				Printf24("LETTRE-SAISIE ",x,y,line_color,0,fill_color);
				Printf24("LETTRE",x,y,line_color,1,fill_color);
				break;
			}
		break;
	case PINYIN_INPUT:
		switch(Language)
			...
			case PORTUGAL:	//葡萄牙
				...
				break;
			case FRENCH:	//法语	
				Printf24("PINYIN-SAISIE ",x,y,line_color,0,fill_color);
				Printf24("PINYIN",x,y,line_color,1,fill_color);
				break;
			}
		break;	
