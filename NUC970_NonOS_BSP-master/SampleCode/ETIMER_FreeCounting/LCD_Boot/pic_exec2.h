...
//------------文件缓存地址--------
#define  PIC_DIS_SAVE1		0xa0400000    //当前显示区块 暂存区1
#define  PIC_DIS_SAVE2		0xa047d000    //当前显示区块 暂存区2
#define  PIC_DIS_SAVE3		0xa0500000    //当前显示区块 暂存区3
#define  PIC_DIS_SAVE4		0xa057d000    //当前显示区块 暂存区4


#define  df_zk_sdram        0xa0600000             //字库2M
...
#define  F3_PLUS_UP_sdram	(F2_TOOLS_UP_sdram+6970)//F3++up
...
//---------------------------------
#define  K_SIZE_sdram		0xa1e00000       //刀数据 缓存区
