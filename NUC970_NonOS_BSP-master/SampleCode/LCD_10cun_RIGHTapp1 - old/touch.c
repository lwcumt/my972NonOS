			...
			switch(WorkMode)
				...
				case SELF_CUT_MODE:  //自刀主 模式
					if(Touch_Pos.y>F6_BUTTON_Y2)
						{
						if((Touch_Pos.y>=FLAG_S0_Y1)&&(Touch_Pos.y<=FLAG_S0_Y2))
							{
							if(WorkMode==AUTO_MODE)//自动画面下
								{
								if((Touch_Pos.x>=FLAG_S0_X1)&&(Touch_Pos.x<=FLAG_S0_X2))
									Touch_code=SHIFT_0_KEY_CODE;	//shift+0------ 气垫标记
								else if((Touch_Pos.x>=FLAG_S1_X1)&&(Touch_Pos.x<=FLAG_S1_X2))
									Touch_code=SHIFT_1_KEY_CODE;	//shift+1------ 压纸标记
								else if((Touch_Pos.x>=FLAG_S2_X1)&&(Touch_Pos.x<=FLAG_S2_X2))
									Touch_code=SHIFT_2_KEY_CODE;	//shift+2------ 理纸标记
								else if((Touch_Pos.x>=FLAG_S3_X1)&&(Touch_Pos.x<=FLAG_S3_X2))
									Touch_code=SHIFT_3_KEY_CODE;	//shift+3------ 推纸标记
								else if((Touch_Pos.x>=FLAG_S4_X1)&&(Touch_Pos.x<=FLAG_S4_X2))
									Touch_code=SHIFT_4_KEY_CODE;	//shift+4------ 刀标记
								else if((Touch_Pos.x>=FLAG_S5_X1)&&(Touch_Pos.x<=FLAG_S5_X2))
									Touch_code=SHIFT_5_KEY_CODE;	//shift+F5------ 添加所有刀标记	
								}
							}
						...
						if((Touch_Pos.x>=F1_BUTTON_X1)&&(Touch_Pos.x<=F1_BUTTON_X2))  //F1,2,3,4子模式
							...
							// // if(WorkMode==AUTO_MODE)//自动画面下
								// // {
								// // if((Touch_Pos.x>=FLAG_S0_X1)&&(Touch_Pos.x<=FLAG_S0_X2)) //	标记按钮
									// // {
									// // if((Touch_Pos.y>=FLAG_S0_Y1)&&(Touch_Pos.y<=FLAG_S0_Y2))
										// // Touch_code=SHIFT_0_KEY_CODE;	//shift+0------ 气垫标记
									// // else if((Touch_Pos.y>=FLAG_S1_Y1)&&(Touch_Pos.y<=FLAG_S1_Y2))
										// // Touch_code=SHIFT_1_KEY_CODE;	//shift+1------ 压纸标记
									// // else if((Touch_Pos.y>=FLAG_S2_Y1)&&(Touch_Pos.y<=FLAG_S2_Y2))
										// // Touch_code=SHIFT_2_KEY_CODE;	//shift+2------ 理纸标记
									// // else if((Touch_Pos.y>=FLAG_S3_Y1)&&(Touch_Pos.y<=FLAG_S3_Y2))
										// // Touch_code=SHIFT_3_KEY_CODE;	//shift+3------ 推纸标记
									// // else if((Touch_Pos.y>=FLAG_S4_Y1)&&(Touch_Pos.y<=FLAG_S4_Y2))
										// // Touch_code=SHIFT_4_KEY_CODE;	//shift+4------ 刀标记
									// // else if((Touch_Pos.y>=FLAG_S5_Y1)&&(Touch_Pos.y<=FLAG_S5_Y2))
										// // Touch_code=SHIFT_5_KEY_CODE;	//shift+F5------ 添加所有刀标记
									// // }
								// // }
							}
