...
#define LED0_ON      GPIO_SetBit(GPIOF, LED0)
#define LED0_OFF     GPIO_ClrBit(GPIOF, LED0)
...
#define LED2_DirInit (GPIO_OpenBit(GPIOF, LED2, DIR_OUTPUT, NO_PULL_UP))
#define LED2_ON      GPIO_SetBit(GPIOF, LED2)
#define LED2_OFF     GPIO_ClrBit(GPIOF, LED2)
...
#define RLOUT1_OFF         GPIO_SetBit(GPIOG, RLOUT1)
#define RLOUT1_ON        GPIO_ClrBit(GPIOG, RLOUT1)
...
#define RLOUT2_OFF          GPIO_SetBit(GPIOG, RLOUT2)
#define RLOUT2_ON        GPIO_ClrBit(GPIOG, RLOUT2)
...
#define RLOUT3_OFF          GPIO_SetBit(GPIOG, RLOUT3)
#define RLOUT3_ON        GPIO_ClrBit(GPIOG, RLOUT3)
...
#define RLOUT4_OFF           GPIO_SetBit(GPIOG, RLOUT4)
#define RLOUT4_ON       GPIO_ClrBit(GPIOG, RLOUT4)



#define RLOUT4_1  BIT11
#define RLOUT4_1_DirInit    (GPIO_OpenBit(GPIOG, RLOUT4_1, DIR_OUTPUT, NO_PULL_UP))
#define RLOUT4_1_OFF           GPIO_SetBit(GPIOG, RLOUT4_1)
#define RLOUT4_1_ON       GPIO_ClrBit(GPIOG, RLOUT4_1)
...
#define RLOUT5_OFF          GPIO_SetBit(GPIOF, RLOUT5)
#define RLOUT5_ON        GPIO_ClrBit(GPIOF, RLOUT5)
...
#define OOUT1_OFF          GPIO_SetBit(GPIOH, OOUT1)
#define OOUT1_ON        GPIO_ClrBit(GPIOH, OOUT1)
...
#define OOUT2_OFF           GPIO_SetBit(GPIOH, OOUT2)
#define OOUT2_ON       GPIO_ClrBit(GPIOH, OOUT2)
...
#define OOUT3_OFF          GPIO_SetBit(GPIOH, OOUT3)
#define OOUT3_ON        GPIO_ClrBit(GPIOH, OOUT3)
...
#define OOUT4_OFF         GPIO_SetBit(GPIOH, OOUT4)
#define OOUT4_ON        GPIO_ClrBit(GPIOH, OOUT4)
