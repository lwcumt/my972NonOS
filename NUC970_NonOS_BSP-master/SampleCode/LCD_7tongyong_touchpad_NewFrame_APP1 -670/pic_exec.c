...
switch(motor)
	...
	case MOTOR_DC_SERVO:	 		//直流伺服	
		...
		switch(Language)
			{
			case CHN_HAN:
				Printf24("4------直流伺服(无效)",x,y,F_color,1,B_color);
				break;
			case ENGLISH:
	...
	case MOTOR_DC670_SERVO:	 		//直流伺服	670
		...
		switch(Language)
			{
			case CHN_HAN:
				Printf24("5------直流伺服670(无效)",x,y,F_color,1,B_color);
				break;
			case ENGLISH:
	...
	case MOTOR_DC670_SERVO_ZHU:	 		//直流伺服	670朱
		...
		switch(Language)
			{
			case CHN_HAN:
				Printf24("6------直流伺服670朱(无效)",x,y,F_color,1,B_color);
				break;
			case ENGLISH:
	...
	case MOTOR_AC_SERVO:	 		//交流伺服	
		...
		switch(Language)
			{
			case CHN_HAN:
				Printf24("7------交流伺服改670",x,y,F_color,1,B_color);
				break;
			case ENGLISH:
