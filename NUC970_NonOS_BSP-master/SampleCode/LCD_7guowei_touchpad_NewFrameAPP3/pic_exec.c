...
if(BmpJudge((Int32U)F6_EXIT_BUTT_sdram)==0)
FileFolderRead("bF6退出.bmp",(unsigned char*)F6_EXIT_BUTT_sdram);//

FileFolderRead("F4推纸up.bmp",(unsigned char*)F4_PUSH_UP_sdram);//
if(BmpJudge((Int32U)F4_PUSH_UP_sdram)==0)
FileFolderRead("bF4推纸up.bmp",(unsigned char*)F4_PUSH_UP_sdram);//
...
FileFolderRead("bF1基准up.bmp",(unsigned char*)F1_RULER_UP_sdram);//
FileFolderRead("F2参数up.bmp",(unsigned char*)F2_TOOLS_UP_sdram);//
if(BmpJudge((Int32U)F2_TOOLS_UP_sdram)==0)
FileFolderRead("bF2参数up.bmp",(unsigned char*)F2_TOOLS_UP_sdram);//
FileFolderRead("F1完成up.bmp",(unsigned char*)F1_FINISHED_sdram);//
if(BmpJudge((Int32U)F1_FINISHED_sdram)==0)
FileFolderRead("bF1完成up.bmp",(unsigned char*)F1_FINISHED_sdram);//
...
FileFolderRead("b红刀图标.bmp",(unsigned char*)RED_KNIFE_F_sdram);//
FileFolderRead("推纸图标.bmp",(unsigned char*)PUSH_PAPER_F_sdram);//
if(BmpJudge((Int32U)PUSH_PAPER_F_sdram)==0)
FileFolderRead("b推纸图标.bmp",(unsigned char*)PUSH_PAPER_F_sdram);//
...
if(BmpJudge((Int32U)CURSOR_sdram)==0)
FileFolderRead("barrow.bmp",(unsigned char*)CURSOR_sdram);//
...
FileFolderRead("bFF键up.bmp",(unsigned char*)F_KEY_UP_sdram);//
...
if(BmpJudge((Int32U)F5_CUT_UP_sdram)==0)
FileFolderRead("bF5刀up.bmp",(unsigned char*)F5_CUT_UP_sdram);//
FileFolderRead("F0全刀up.bmp",(unsigned char*)F0_ALLCUT_UP_sdram);//
if(BmpJudge((Int32U)F0_ALLCUT_UP_sdram)==0)
FileFolderRead("bF0全刀up.bmp",(unsigned char*)F0_ALLCUT_UP_sdram);//
...
if(BmpJudge((Int32U)F4_PULSE_UP_sdram)==0)
FileFolderRead("bF4脉冲当量up.bmp",(unsigned char*)F4_PULSE_UP_sdram);

FileFolderRead("F3标签次数up.bmp",(unsigned char*)LABEL_TIME_F3_UP_sdram);//
if(BmpJudge((Int32U)LABEL_TIME_F3_UP_sdram)==0)
FileFolderRead("bF3标签次数up.bmp",(unsigned char*)LABEL_TIME_F3_UP_sdram);//
FileFolderRead("F3标签次数down.bmp",(unsigned char*)LABEL_TIME_F3_DOWN_sdram);//
if(BmpJudge((Int32U)LABEL_TIME_F3_DOWN_sdram)==0)
FileFolderRead("bF3标签次数down.bmp",(unsigned char*)LABEL_TIME_F3_DOWN_sdram);//
FileFolderRead("F4标签废边up.bmp",(unsigned char*)LABEL_DESERT_F4_UP_sdram);//
if(BmpJudge((Int32U)LABEL_DESERT_F4_UP_sdram)==0)
FileFolderRead("bF4标签废边up.bmp",(unsigned char*)LABEL_DESERT_F4_UP_sdram);//
FileFolderRead("F4标签废边down.bmp",(unsigned char*)LABEL_DESERT_F4_DOWN_sdram);//
if(BmpJudge((Int32U)LABEL_DESERT_F4_DOWN_sdram)==0)
FileFolderRead("bF4标签废边down.bmp",(unsigned char*)LABEL_DESERT_F4_DOWN_sdram);//
...
if(BmpJudge((Int32U)RUN_BIG_BUTT_UP_sdram)==0)
FileFolderRead("b运行BIGup.bmp",(unsigned char*)RUN_BIG_BUTT_UP_sdram);
FileFolderRead("停止BIGup.bmp",(unsigned char*)STOP_BIG_BUTT_UP_sdram);
if(BmpJudge((Int32U)STOP_BIG_BUTT_UP_sdram)==0)
FileFolderRead("b停止BIGup.bmp",(unsigned char*)STOP_BIG_BUTT_UP_sdram);
...
void F2_ToolsPage1_dis(void) //参数 画面1
{
...
void F2_ToolsPage2_dis(void) //参数 画面2
{
volatile Int16U x,y,gap,n,tx_wide=148;
Int16U back_color=TEXT_TAB_BACK_COLOR;	//0xef9f;
 x=PARA_START_X1,y=PARA_START_Y,gap=PARA_ROW_GAP;
...
// if(SelfLockEn_flag == 0) //  未定位--20180103
	RLOUT1_ON;RLOUT1_1_ON;    // 允许裁切断开
// else
	// {
	// if(PressDown_flag == 0)// 压纸 未下	20171024
		// RLOUT1_ON;    // 允许裁切断开
	// }
CutPermit_flag=0;	
}
