...
extern void DCServoMove_To(Int32U position,Int8U jog_flag);  //运行 目标值

extern void ServoComm_exec(Int8U data); //伺服数据接收

extern void SaveMovSpeed(void);
extern void ReadJogSpeed(void);
extern void SaveJogSpeed(void);
extern void Read_PitchRatio(void);
extern void Save_PitchRatio(void);
extern Int32U MotorPositionToHex(void);
extern Int32U ServoSpeedData(void);
extern void ServoPositionRing(void);  //位置环 参数
extern void ServoRev_Exec(void);
