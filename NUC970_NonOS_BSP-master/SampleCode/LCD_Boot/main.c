...
#define EXT_SDRAM  0//0x00000058// 0x80000000//0x8003285c
...
////////	GLCD_Buffer_Fill(GREEN_COLOR);
//////sysprintf("Now Enter App...\r\n");
 AppEntry();
