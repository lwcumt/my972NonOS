...
extern unsigned int const  waitTb1[120],waitTb2[120],waitTb3[120],waitTb4[120],waitTb5[120],waitTb6[120],waitTb7[120],waitTb8[120],
                          waitTb9[120],waitTb10[120],waitTb11[120],waitTb12[120],waitTb13[120],waitTb14[120],waitTb15[120],waitTb16[120],
													waitTb17[120],waitTb18[120],waitTb19[120],waitTb20[120],waitTb21[120],waitTb22[120],waitTb23[120],waitTb24[120],
													waitTb25[120],waitTb26[120],waitTb27[120],waitTb28[120],waitTb29[120],waitTb30[120],waitTb31[120],waitTb32[120],waitTb33[120];
...
extern void AC_ChangeSPD(void);
extern void ACMotorRunStart(Int32U vbcd); //  AC伺服  运行启动
extern void ACMotorGoForward(void);  //前进
extern void ACMotorGoBack(void);  //后退
extern void ACMotorGoFastForward(void);  // 快进
extern void ACMotorGoFastBack(void);  //快退
extern void ACMotor_ReleaseStop(void);
